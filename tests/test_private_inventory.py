...
class PrivateInventoryTests(unittest.TestCase):
    def test_preserves_private_to_public_skill_identity(self) -> None:
        audit = {
            "schema_version": 1,
        ...
        previous = {
            "skills": {
                "private-cloud": {
                    ...
                    "portable_aliases": {"private-cloud": "product-cloud-operations"},
                    "decision": {},
                }
            }
        }
        result = MODULE.build_ledger(
            ...
            {
                "provenance_groups": {
                    "owned": {"origin": "this-repository", "license": "MIT"}
                },
                "skills": {"product-cloud-operations": "owned"},
            },
            {
        ...
        record = result["skills"]["private-cloud"]
        self.assertEqual(record["disposition"]["status"], "bundled")
        self.assertEqual(record["public_name"], "product-cloud-operations")
        self.assertEqual(result["catalog_only_skills"], [])

    def test_preserves_shared_private_reference_aliases(self) -> None:
        audit = {
            "schema_version": 1,
            "sensitivity": "private_intake",
            "entry_mode": "top-level",
        ...
        result = MODULE.build_ledger(
            ...
            {"profiles": {}, "skill_packs": {}},
            previous,
        )

        self.assertEqual(
            result["portable_reference_aliases"],
            {"private-suite/": "public-suite/"},
        )
