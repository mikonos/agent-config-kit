---
name: release-skills
description: Release and publish skills. Use when packaging or distributing skill files.
---
...
**Example Commits**:
```bash
git commit -m "feat(example-skill-a): add watercolor and minimalist styles"
git commit -m "fix(example-skill-b): improve panel layout for long dialogues"
...
```
Commits created:
  1. feat(example-skill-a): add watercolor and minimalist styles
  2. fix(example-skill-b): improve panel layout for long dialogues
  3. docs(project): update architecture documentation

Changelog preview (en):
  ## 1.3.0 - 2026-01-22
  ### Features
  - Add watercolor and minimalist styles to example-skill-a
  ### Fixes
  - Improve panel layout for long dialogues in example-skill-b
...
Changes grouped by skill/module:
  example-skill-a:
    ...
    → Commit: feat(example-skill-a): add watercolor and minimalist styles
    → README updates: options table

  example-skill-b:
    - fix: panel layout for long dialogues
    → Commit: fix(example-skill-b): improve panel layout for long dialogues
    → No README updates
...
Changelog preview (zh):
  ## 1.3.0 - 2026-01-22
  ### 新功能
  - 为 example-skill-a 添加水彩和极简风格
  ### 修复
  - 改进 example-skill-b 长对话的面板布局
