# 方法论锚点 · evidence-research-suite 理论根源参考

> **这是什么**：evidence-research-suite skill 十个工具背后的理论根源参考。SKILL.md 主体只给每个工具的轮廓与硬约定，深层「这个工具背后的理论凭什么成立、关键术语怎么用、和哪些专家关联」由本文件兜底。
>
