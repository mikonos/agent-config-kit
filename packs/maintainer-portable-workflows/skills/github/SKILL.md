...
## Project-specific submission standards

For repository-specific issue/PR submission conventions (title prefixes, body templates, label decision trees, anti-patterns), see:

- **`project-issue`** — `sunsetyyun/project` (product) issue 提交规范：8 种类型、P0/P1/P2 优先级、13 字段模板、label 决策树、HTML 原型处理
