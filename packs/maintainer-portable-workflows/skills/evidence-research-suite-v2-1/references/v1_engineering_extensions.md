...
parent_skill: research-research-suite
sourced_from: research-research-suite-v1 (archived) + research_v4_日历机 example
...
# research-research-suite · v1 工程化扩展（v2.1：推荐默认开启）

> **这是什么**：research-research-suite v1 经过 4 轮迭代（v1→v2→v3→v4）沉淀的 7 类工程化机制。v2.1 升级为**推荐默认开启层**——每条扩展都是 4 轮迭代沉淀的工程化经验，默认开启除非有明确关闭场景。
> **两层硬度声明**：
...
## 与 research-research-suite SKILL.md 的关系（v2.1）
