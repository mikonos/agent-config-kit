# research-research-suite · Original Prompt Blocks（Prompt 真源）

> 本文件是 research-research-suite skill 的 prompt 真源。源稿：`05_每日记录/2025/12/20251218/20251218_用户研究十大提示词工具集_从洞察到创新的完整方法论.md`（2025-12-18 研究者原稿）。
